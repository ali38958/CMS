...
<head>
    ...
    <title>Complaint Cloud - Dashboard</title>
    ...
    <style>
        * {
        ...
        :root {
            ...
            --nav-active: rgba(110, 142, 251, 0.15);
            --nav-hover: rgba(110, 142, 251, 0.08);
        }

        body {
            background: linear-gradient(135deg, #a0c0ff, #c3b5ff, #b8e0ff);
            min-height: 100vh;
            overflow-x: hidden;
            position: relative;
        }
...
<body>
    ...
    <script>
                ...
                complaintCards: [
                    {
                        ...
                        desc: "After the latest software update, the product stopped functioning...",
                        customer: "Sarah Williams",
                        priority: { level: "high", text: "High" }
                    },
                    {
        ...
        // Function to generate all users table rows
        ...
        function addNewUser() {
            ...
            appData.users.allUsers.push(newUser);
